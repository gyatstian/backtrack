...
constexpr int kInputDeviceComboId = 87;
    ...
    constexpr int kNotificationSoundVolumeEditId = 212;
    constexpr int kCustomNotificationSoundEditId = 220;
    constexpr int kBrowseCustomNotificationSoundButtonId = 221;
    constexpr int kResetCustomNotificationSoundButtonId = 222;
...
constexpr int kCaptureMethodComboId = 114;
constexpr int kGameCaptureModeComboId = 215;
constexpr int kAllowAntiCheatGameCaptureCheckId = 216;
constexpr int kFollowMouseMonitorCheckId = 115;
constexpr int kFollowFocusedMonitorCheckId = 116;
constexpr int kMultiMonitorSupportCheckId = 217;
...
constexpr int kSettingsCategoryButtonBaseId = 120;
    ...
    constexpr int kCaptureCursorCheckId = 213;
...
constexpr int kVoiceCommandComboId = 218;
constexpr int kDiscordRichPresenceComboId = 219;
constexpr int kPruneStaleMicrophoneConsentEntriesCheckId = 214;
constexpr int kStatsLabelId = 301;
constexpr int kCapsLabelId = 302;
constexpr int kSaveLogButtonId = 303;
constexpr int kDiagnosticLogLabelId = 304;
constexpr int kLogLevelComboId = 305;
constexpr int kOpenLogFolderButtonId = 306;
constexpr int kUpdateButtonId = 307;
...
constexpr UINT_PTR kControllerBusyTimerId = 2;
constexpr UINT kDiagnosticsRefreshMs = 1000;
constexpr UINT kControllerBusySoftTimeoutMs = 15000;
...
constexpr UINT kUpdateCheckCompleteMessage = WM_APP + 5;
constexpr UINT kVoiceCommandMessage = WM_APP + 6;
...
constexpr COLORREF kTabActive = RGB(48, 92, 150);
constexpr COLORREF kButtonHover = RGB(42, 46, 54);
constexpr COLORREF kButtonPressed = RGB(38, 72, 118);
